...
export function DashboardLayout({ children }: any) {
    ...
    const navigation = [
        { name: t('HOME'), href: '/dashboard', current: true },
        { name: t('USERS'), href: '/dashboard/users', current: false },
        { name: t('TEAMS'), href: '/dashboard/teams', current: false },
        { name: t('TOURNEMENTS'), href: '/dashboard/tournements', current: false },
        { name: t('STATISTICAL'), href: '/dashboard/statsticals', current: false },
    ]
